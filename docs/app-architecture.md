...
- Testing policy and tags: [E2E Strategy](testing/e2e-strategy.md).

## Decision Log

- Architecture-significant decisions are tracked as ADRs in [Architecture Decision Log](development/decisions/README.md).
