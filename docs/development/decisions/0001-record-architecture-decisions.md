...
We adopt a lightweight ADR process in [the decisions folder](./):
...
- central index in [Architecture Decision Log](README.md)
...
- Keep all decisions only in [App Architecture](../../app-architecture.md): rejected, because history and rationale are hard to track.
